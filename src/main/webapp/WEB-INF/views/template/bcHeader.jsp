...
<body>
    ...
    <div class="brand">It's a Dog's Life</div>
    <div class="address-bar">Apparel | Collars and Leads | Accessories</div>
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">A Dog's Life</a>
            </div>
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav pmc-navbar-text">
					...
					<c:choose>
						<c:when test="${authenticated}">
							<li><a href="<c:url value="#" />">Welcome <sec:authentication property="name" /></a></li>
