...
INSERT INTO websystique.customer (email, phone, first_name, last_name, user_id)
VALUES('pchapman@easystreet.net','503-449-0882','Peter','Chapman', (select user_id from websystique.app_user where sso_id = 'pchapman'));

UPDATE websystique.app_user set customer_customer_id = (select customer_id from websystique.customer where customer.email = 'pchapman@easystreet.net')
